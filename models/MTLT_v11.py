...
class MTLT_v11(nn.Module):
    def __init__(self):
        ...
        self.dec_block2 = nn.Sequential(
            nn.ConvTranspose2d(512, 256, (8, 1)),
        ...
        self.dec_block7 = nn.Sequential(
            nn.ConvTranspose2d(16, 8, (1, 36), stride=(1, 2), padding=(0, 1)),
            nn.InstanceNorm2d(8),
            nn.ReLU(True)
        )

        self.dec_block8 = nn.Sequential(
            nn.ConvTranspose2d(8, 1, (8, 1), stride=(2, 1), padding=(2, 0)),
            nn.InstanceNorm2d(1),
            nn.ReLU(True)
        )
