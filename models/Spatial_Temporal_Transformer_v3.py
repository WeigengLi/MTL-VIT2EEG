...
'''
    Have both CLS and PE
'''

class Spatial_Temporal_Transformer_v3(nn.Module):
    def __init__(self, input_dim=129, max_len=500, output_dim=2, d_model=512, num_heads=8, num_encoder_layers=6,
                 num_decoder_layers=6):
        super(Spatial_Temporal_Transformer_v3, self).__init__()
    ...
    def forward(self, x):
        ...
        # Add CLS token
        cls_token = self.cls_token.repeat(1, x.size(1), 1)
...
if __name__ == '__main__':
    ...
    model = Spatial_Temporal_Transformer_v3()
