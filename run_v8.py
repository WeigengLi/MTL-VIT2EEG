from dataset.Datasets import EEGEyeNetDataset
import torch
import torch.nn as nn
from torch.utils.data import DataLoader, Subset
from tqdm import tqdm
import numpy as np
from models.Spatial_Temporal_Transformer_v8 import Spatial_Temporal_Transformer_v8
import math
...
def train(model, optimizer, scheduler=None):
    ...
    train_indices, val_indices, test_indices = split(EEGEyeNet.trainY[:, 0], 0.7, 0.15,
